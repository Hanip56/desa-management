...
const PersyaratanAktivasiPage = () => {
  return (
    <main>
      <Header title="Persyaratan Aktivasi" withBreadcrumb />
        ...
        <CardContent className="sm:px-10">
          <ListsPersyaratan
            lists={[
              ...
              "Fotocopy SPPT yang mau di aktif kan",
              "Surat keterangan kepala desa di TTD kepala desa yang menerangkan untuk pengaktifan kembali NOP tersebut pada SPPT PBB",
              "Materai 10.000",
            ]}
          />
        </CardContent>
...
export default PersyaratanAktivasiPage;
