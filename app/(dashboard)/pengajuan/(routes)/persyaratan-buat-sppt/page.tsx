...
const PersyaratanBuatSpptPage = () => {
  return (
    <main>
      <Header title="Persyaratan Buat SPPT (OP BARU)" withBreadcrumb />
        ...
        <CardContent className="sm:px-10">
          <ListsPersyaratan
            lists={[
              ...
              "Fotocopy SPPT Tetangga",
              "Surat keterangan kepala desa di TTD Desa yang menerangkan untuk Objek Pajak baru atau belum mempunyai SPPT PBB",
              "Materai 10.000",
            ]}
          />
        </CardContent>
...
export default PersyaratanBuatSpptPage;
