...
import { getAllPendaftaranPindahWni } from "@/fetcher/pendaftaran-pindah-wni-fetcher";
...
export const PendaftaranPindahWniClient = () => {
  const [
    page,
    handleNext,
    handlePrevious,
  ...
  const query = useQuery({
    queryKey: ["pendaftaran-pindah-wnis", { page, search, status, updatedAt }],
    queryFn: () =>
      getAllPendaftaranPindahWni({
        page,
        limit,
        search,
        status,
      ...
      <CardHeader className="flex flex-col md:flex-row items-center md:justify-between gap-y-2">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Button asChild className="w-full md:w-fit">
            <Link href="pendaftaran-pindah-wni/formulir">
