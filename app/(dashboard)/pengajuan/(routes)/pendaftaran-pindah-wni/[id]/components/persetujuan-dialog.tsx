...
import { updatePendaftaranPindahWni } from "@/fetcher/pendaftaran-pindah-wni-fetcher";
...
type Props = {
  open: boolean;
  handleClose: () => void;
  initialData: PendaftaranPindahWniWithUser;
};
...
const PersetujuanDialog = ({ open, handleClose, initialData }: Props) => {
  ...
  const noSuratDefault = `470/.../PEM/${new Date().getFullYear()}`;
