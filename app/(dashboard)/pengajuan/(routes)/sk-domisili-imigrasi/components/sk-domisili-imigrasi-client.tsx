...
import { getAllSkDomisiliImigrasi } from "@/fetcher/sk-domisili-imigrasi-fetcher";
...
export const SkDomisiliImigrasiClient = () => {
  const [
    page,
    handleNext,
    handlePrevious,
  ...
  const query = useQuery({
    queryKey: ["sk-domisili-imigrasis", { page, search, status, updatedAt }],
    queryFn: () =>
      getAllSkDomisiliImigrasi({
        page,
        limit,
        search,
        status,
      ...
      <CardHeader className="flex flex-col md:flex-row items-center md:justify-between gap-y-2">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Button asChild className="w-full md:w-fit">
            <Link href="sk-domisili-imigrasi/formulir">
