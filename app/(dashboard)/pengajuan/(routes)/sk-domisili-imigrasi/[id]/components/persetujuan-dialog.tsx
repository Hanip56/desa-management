...
import { updateSkDomisiliImigrasi } from "@/fetcher/sk-domisili-imigrasi-fetcher";
...
type Props = {
  open: boolean;
  handleClose: () => void;
  initialData: SkDomisiliImigrasiWithUser;
};
...
const PersetujuanDialog = ({ open, handleClose, initialData }: Props) => {
  ...
  return (
    <Modal
      ...
      description="Surat keterangan domisili imigrasi"
      isOpen={open}
      onClose={handleClose}
    >
      <Form {...form}>
