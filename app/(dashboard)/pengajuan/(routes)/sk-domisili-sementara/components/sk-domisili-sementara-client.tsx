...
import { getAllSkDomisiliSementara } from "@/fetcher/sk-domisili-sementara-fetcher";
...
export const SkDomisiliSementaraClient = () => {
  const [
    page,
    handleNext,
    handlePrevious,
  ...
  const query = useQuery({
    queryKey: ["sk-domisili-sementaras", { page, search, status, updatedAt }],
    queryFn: () =>
      getAllSkDomisiliSementara({
        page,
        limit,
        search,
        status,
      ...
      <CardHeader className="flex flex-col md:flex-row items-center md:justify-between gap-y-2">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Button asChild className="w-full md:w-fit">
            <Link href="sk-domisili-sementara/formulir">
