...
import { getAllSuratRekomendasiPembelianBbm } from "@/fetcher/surat-rekomendasi-pembelian-bbm-fetcher";
...
export const SuratRekomendasiPembelianBbmClient = () => {
  const [
    page,
    handleNext,
    handlePrevious,
  ...
  const query = useQuery({
    queryKey: [
      "surat-rekomendasi-pembelian-bbms",
      { page, search, status, updatedAt },
    ],
    queryFn: () =>
      getAllSuratRekomendasiPembelianBbm({
        page,
        limit,
        search,
        status,
      ...
      <CardHeader className="flex flex-col md:flex-row items-center md:justify-between gap-y-2">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Button asChild className="w-full md:w-fit">
            <Link href="surat-rekomendasi-pembelian-bbm/formulir">
