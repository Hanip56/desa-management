...
import { getAllSkTidakMampu } from "@/fetcher/sk-tidak-mampu-fetcher";
...
export const SkTidakMampuClient = () => {
  const [
    page,
    handleNext,
    handlePrevious,
  ...
  const query = useQuery({
    queryKey: ["sk-tidak-mampus", { page, search, status, updatedAt }],
    queryFn: () =>
      getAllSkTidakMampu({
        page,
        limit,
      ...
      <CardHeader className="flex flex-col md:flex-row items-center md:justify-between gap-y-2">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Button asChild className="w-full md:w-fit">
            <Link href="sk-tidak-mampu/formulir">
