...
import { getAllSkBelumMemilikiRumah } from "@/fetcher/sk-belum-memiliki-rumah-fetcher";
...
export const SkBelumMemilikiRumahClient = () => {
  const [
    page,
    handleNext,
    handlePrevious,
  ...
  const query = useQuery({
    queryKey: ["sk-belum-memiliki-rumahs", { page, search, status, updatedAt }],
    queryFn: () =>
      getAllSkBelumMemilikiRumah({
        page,
        limit,
        search,
        status,
      ...
      <CardHeader className="flex flex-col md:flex-row items-center md:justify-between gap-y-2">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Button asChild className="w-full md:w-fit">
            <Link href="sk-belum-memiliki-rumah/formulir">
