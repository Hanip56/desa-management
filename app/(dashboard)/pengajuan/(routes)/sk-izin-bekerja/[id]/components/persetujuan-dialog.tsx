...
import { updateSkIzinBekerja } from "@/fetcher/sk-izin-bekerja-fetcher";
...
type Props = {
  open: boolean;
  handleClose: () => void;
  initialData: SkIzinBekerjaWithUser;
};
...
const PersetujuanDialog = ({ open, handleClose, initialData }: Props) => {
  ...
  return (
    <Modal
      ...
      description="Surat keterangan izin bekerja"
      isOpen={open}
      onClose={handleClose}
    >
      <Form {...form}>
