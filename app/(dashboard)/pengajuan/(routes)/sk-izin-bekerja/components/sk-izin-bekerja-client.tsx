...
import { getAllSkIzinBekerja } from "@/fetcher/sk-izin-bekerja-fetcher";
...
export const SkIzinBekerjaClient = () => {
  const [
    page,
    handleNext,
    handlePrevious,
  ...
  const query = useQuery({
    queryKey: ["sk-izin-bekerjas", { page, search, status, updatedAt }],
    queryFn: () =>
      getAllSkIzinBekerja({
        page,
        limit,
      ...
      <CardHeader className="flex flex-col md:flex-row items-center md:justify-between gap-y-2">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Button asChild className="w-full md:w-fit">
            <Link href="sk-izin-bekerja/formulir">
