...
import { getAllSkUsaha } from "@/fetcher/sk-usaha-fetcher";
...
export const SkUsahaClient = () => {
  ...
  const query = useQuery({
    queryKey: ["sk-usahas", { page, search, status, updatedAt }],
    queryFn: () =>
      getAllSkUsaha({
        page,
        limit,
