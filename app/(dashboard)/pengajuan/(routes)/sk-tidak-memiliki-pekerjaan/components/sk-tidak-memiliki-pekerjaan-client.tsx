...
import { getAllSkTidakMemilikiPekerjaan } from "@/fetcher/sk-tidak-memiliki-pekerjaan-fetcher";
...
export const SkTidakMemilikiPekerjaanClient = () => {
  const [
    page,
    handleNext,
    handlePrevious,
      ...
      <CardHeader className="flex flex-col md:flex-row items-center md:justify-between gap-y-2">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Button asChild className="w-full md:w-fit">
            <Link href="sk-tidak-memiliki-pekerjaan/formulir">
