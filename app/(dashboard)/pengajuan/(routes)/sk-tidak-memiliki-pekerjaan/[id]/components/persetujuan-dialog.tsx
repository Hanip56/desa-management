...
import { updateSkTidakMemilikiPekerjaan } from "@/fetcher/sk-tidak-memiliki-pekerjaan-fetcher";
...
type Props = {
  open: boolean;
  handleClose: () => void;
  initialData: SkTidakMemilikiPekerjaanWithUser;
};
...
const PersetujuanDialog = ({ open, handleClose, initialData }: Props) => {
  ...
  return (
    <Modal
      ...
      description="Surat keterangan tidak memiliki pekerjaan"
      isOpen={open}
      onClose={handleClose}
    >
      <Form {...form}>
